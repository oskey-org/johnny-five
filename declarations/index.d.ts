...
export interface LCDI2COption extends LCDGeneralOption {
  controller: "PCF8574" | "PCF8574A" | "JHD1313M1";
  backlight?: number;
}
...
export interface ExpanderGeneralOption {
  controller: "MCP23017" | "MCP23008" | "PCF8574" | "PCF8574A" | "PCF8575" | "" | "PCA9685" | "MUXSHIELD2" | "GROVEPI" | "74HC595" | "CD74HC4067";
  address?: number;
}

export declare class Expander {
  constructor(option: ExpanderGeneralOption);

  id: string;
  pin: number | string;
  MODES: any;

  normalize(pin: number): void;
  pinMode(pin: number, mode: number): void;
  analogRead(pin: number, handler: (value: number) => void): Pin;
  digitalRead(pin: number, handler: (value: number) => void): Pin;
